...
namespace Learning___Program
{
    ...
    public partial class PythonLesson2Form : Form
    {
        ...
        public PythonLesson2Form(string username, MainForm mainForm)
        {
            ...
            _lessonId = GetLessonId("Условные операторы (if, else)", "Python");
        ...
        {
            // Вопрос 1
            question1GroupBox.Text = "1. Какой оператор проверяет равенство значений в Python?";
            answer1RadioButton1.Text = "=";
            answer1RadioButton2.Text = "==";
            answer1RadioButton3.Text = "===";
            answer1RadioButton4.Text = "<>";
            ...
            // Вопрос 2
            question2GroupBox.Text = "2. Что выведет программа, если age = 15?";
            answer2RadioButton1.Text = "Доступ разрешён!";
            answer2RadioButton2.Text = "Доступ запрещён.";
            answer2RadioButton3.Text = "Ничего не выведет";
            answer2RadioButton4.Text = "Ошибку";
            ...
            // Вопрос 3
            question3GroupBox.Text = "3. Можно ли писать код if без else?";
            answer3RadioButton1.Text = "Да, это необязательная часть";
            answer3RadioButton2.Text = "Нет, else всегда обязателен";
            answer3RadioButton3.Text = "Только в некоторых случаях";
            answer3RadioButton4.Text = "Только если условие простое";
            ...
            answer4RadioButton1.Text = "if num % 2 == 0:";
            answer4RadioButton2.Text = "if num / 2 == 0:";
            answer4RadioButton3.Text = "if num * 2 == 0:";
            answer4RadioButton4.Text = "if num + 2 == 0:";
        ...
        private void SetupPracticeTab()
        {
            ...
            practiceTaskLabel.Text = "1. Напиши программу, которая:\n" +
                                   "- Запрашивает число\n" +
                                   "- Выводит \"Число положительное\", если оно > 0\n" +
                                   "- Выводит \"Число отрицательное\", если оно < 0\n" +
                                   "- Выводит \"Это ноль\", если число = 0\n\n" +
                                   "Пример работы:\n" +
                                   "Введите число: 5\n" +
                                   "Число положительное";

            checkPracticeButton.Click += (s, e) => {
                if (CheckNumberSignProgram(practiceCodeTextBox.Text))
                {
                    correctAnswersCount++;
                }
            ...
            task2Label.Text = "2. Напиши программу, которая:\n" +
                              "- Запрашивает пароль (например, 12345)\n" +
                              "- Если пароль верный → выводит \"Доступ открыт\"\n" +
                              "- Если неверный → \"Неверный пароль!\"\n\n" +
                              "Пример работы:\n" +
                              "Введите пароль: 12345\n" +
                              "Доступ открыт";

            checkTask2Button.Click += (s, e) => {
                if (CheckPasswordProgram(task2CodeBox.Text))
                {
                    correctAnswersCount++;
                }
        ...
        private bool CheckNumberSignProgram(string userCode)
        {
            userCode = userCode.Trim();
            bool hasIf = userCode.Contains("if") && userCode.Contains(":");
            bool hasElif = userCode.Contains("elif") || userCode.Contains("else if");
            bool hasElse = userCode.Contains("else:");
            bool hasOutput = userCode.Contains("положительное") &&
                            userCode.Contains("отрицательное") &&
                            userCode.Contains("ноль");

            if (hasIf && (hasElif || hasElse) && hasOutput)
            {
            ...
            {
                string exampleSolution = "num = int(input(\"Введите число: \"))\n\nif num > 0:\n    print(\"Число положительное\")\nelse if num < 0:\n    print(\"Число отрицательное\")\nelse:\n    print(\"Это ноль\")";
        ...
        private bool CheckPasswordProgram(string userCode)
        {
            userCode = userCode.Trim();
            bool hasInput = userCode.Contains("input(");
            bool hasIf = userCode.Contains("if") && userCode.Contains("==");
            bool hasElse = userCode.Contains("else:"); 
            bool hasOutput = userCode.Contains("Доступ открыт") &&
                            userCode.Contains("Неверный пароль");

            if (hasInput && hasIf && hasElse && hasOutput)
            {
                MessageBox.Show("Правильно!", "Результат");
                return true;
            }
            ...
            {
                string exampleSolution = "password = input(\"Введите пароль: \")\n\nif password == \"12345\":\n    print(\"Доступ открыт\")\nelse:\n    print(\"Неверный пароль!\")";
                MessageBox.Show($"Неправильно. Пример решения:\n\n{exampleSolution}", "Результат");
                return false;
            }
        }
        ...
        private void SetupAdvancedTab()
        {
            advancedTaskLabel.Text = "Дополнительное задание:\n\n" +
                                    ...
                                    "Правила:\n" +
                                    "- Год високосный, если он делится на 4, но не на 100\n" +
                                    "- Исключение: Если делится на 400, то всё равно високосный\n\n" +
                                    "Пример работы:\n" +
                                    "Введите год: 2024\n" +
                                    "2024 — високосный год!";
        ...
        {
            userCode = userCode.Trim();
            bool hasMod = userCode.Contains("%");
            bool hasComplexCondition = (userCode.Contains("% 4") && userCode.Contains("% 100")) ||
                                     userCode.Contains("% 400");
            ...
            {
                string exampleSolution = "year = int(input(\"Введите год: \"))\n\nif (year % 4 == 0 and year % 100 != 0) or (year % 400 == 0):\n    print(year, \"— високосный год!\")\nelse:\n    print(year, \"— не високосный год.\")";
                MessageBox.Show($"Неправильно. Пример решения:\n\n{exampleSolution}", "Результат");
                return false;
            }
        }
